...
╚══════╝╚═╝  ╚═╝╚═╝╚══════╝╚══════╝╚═════╝  ╚╝╚═══╝ ╚═╝  ╚═╝ ╚═════╝ ╚═╝     ╚═╝╚══════╝
		...
		wget --no-check-certificate 'wget --no-check-certificate 'https://docs.google.com/uc?export=download&id=1rWmTY9GnmF3Ap0OiKJytbYM0F97HKXDC' -O shieldathome.tar.gz'
		;;
